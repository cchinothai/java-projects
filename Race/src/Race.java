...
public class Race extends JFrame {
    ...
    private void prepareToRace() {
        ...
        while (input != 's' && input != 'S') {
            ...
            {
                racerList.add(new FallGuy("Fall Guy", START_LINE, yPos));
               yPos+= RACER_SPACE;
            }
            else
            {
                JOptionPane.showMessageDialog(this,"Error, input a valid racer.");
            }
    ...
    private char getRacer() {
        String input = JOptionPane.showInputDialog(this, "Enter a racer:"
                + "\nt for Tortoise, h for hare, f for fall guy," + "\nor s to start the race");
        if (input == null) {
